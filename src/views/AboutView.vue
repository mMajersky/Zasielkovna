            ...
            <div class="naccs">
              <div class="tabs">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="menu">
                      <div class="active gradient-border" ><span >For customers</span></div>
                      <div class="gradient-border" ><span>For contractors</span></div>
                      <div class="gradient-border" ><span>Storages</span></div>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <ul class="nacc">
